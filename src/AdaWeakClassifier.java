// AdaWeakClassifier.java
// holds the information regarding the AdaBoost weak classifier, here we use the decision stumps
// Sebastien Gambs

import java.io.* ;
import java.lang.* ;

public class AdaWeakClassifier
{
	...
	// constructor
	public AdaWeakClassifier(int d)
	{
		int x;
